...
export default function EditInvoice() {
    const notify = () => toast.success("Invoice Updated Successfully");
        ...
        <div className='py-5'>
           ...
           <br/><br/><br/>
            ...
            <tr>
                ...
                <td><input type="text" id="fname" name="amount" value={amount} onChange={(e)=>setAmount(e.target.value)} style={{ width:"200px"}}/></td>
